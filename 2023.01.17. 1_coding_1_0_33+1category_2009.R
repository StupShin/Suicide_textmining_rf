...
setwd("R:/")
dat<-readxl::read_xlsx('2022.08.18. raw data_2009.xlsx',sheet=1)

library(stringr)

row<-data.frame(dat$ID_1)
...
binded<-cbind(dat[,c(1:9)],row[,c(2:36)])

writexl::write_xlsx(binded,path = '2_binded_2009.xlsx',col_names=T)
